...
def exitProg():
    ...
    saveButton = Button(top, text = 'Save Current Configuration', font = myFont, command = save, bg = 'white', height = 6, width = 55)
    saveButton.grid(row = 1, column = 1, padx = xpadding*20, pady = ypadding*2)

    cancelButton = Button(top, text = 'Return to Controller', font = myFont, command = top.destroy, bg = 'limegreen', height = 6, width = 55)
...
##widgets
bank1EnButton = Button(win, text = 'Bank 1 Dis', font = myFont, command = bank1Update, bg = 'red', height = buttonh, width = buttonw)
...
bank2EnButton = Button(win, text = 'Bank 2 Dis', font = myFont, command = bank2Update, bg = 'red', height = buttonh, width = buttonw)
...
bank3EnButton = Button(win, text = 'Bank 3 Dis', font = myFont, command = bank3Update, bg = 'red', height = buttonh, width = buttonw)
...
bank4EnButton = Button(win, text = 'Bank 4 Dis', font = myFont, command = bank4Update, bg = 'red', height = buttonh, width = buttonw)
